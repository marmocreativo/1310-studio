    ...
    >
        ...
        <div class="flex-1 flex flex-col gap-6">
            ...
            <div class="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-6 flex flex-col gap-5">
                ...
                @if($slide->logo_url)
                    <div class="rounded-lg bg-zinc-100 dark:bg-zinc-800 p-3 flex items-center justify-center" x-show="!previews.logo">
            ...
            <div x-show="tipo === 'video'" class="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-6 flex flex-col gap-5">
                ...
                {{-- Video actual --}}
                @if($slide->video_url)
                    <div class="rounded-lg bg-zinc-100 dark:bg-zinc-800 p-3 flex items-center gap-3">
            ...
            <div x-show="tipo === 'capas'" class="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-6 flex flex-col gap-5">
                ...
                @if($slide->imagen_overlay_url)
                    <div class="rounded-lg bg-zinc-50 dark:bg-zinc-800 p-2 flex justify-center" x-show="!previews.overlay">
        ...
        <div class="w-72 flex flex-col gap-4">
            ...
            {{-- Eliminar --}}
            <div class="rounded-xl border border-red-100 dark:border-red-900/40 bg-white dark:bg-zinc-900 p-5 flex flex-col gap-3">
                <flux:heading size="sm" class="text-red-600 dark:text-red-400">Zona de peligro</flux:heading>
                ...
                >
                    ...
                    <button
                        type="submit"
                        class="w-full rounded-lg border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950 text-sm font-medium px-4 py-2 transition-colors"
                    >
                        Eliminar slide
                    </button>
                </form>
